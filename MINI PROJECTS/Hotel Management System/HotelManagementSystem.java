...
public class HotelManagementSystem extends JFrame {
    ...
    public HotelManagementSystem() {
        ...
        // Set background color for the tabbed pane
    ...
    // Panel for Room Details - Light Blue
    class RoomDetailsPanel extends JPanel {
        public RoomDetailsPanel() {
            ...
            // Style buttons
            styleButton(luxuryDoubleBtn);
            styleButton(deluxeDoubleBtn);
            styleButton(luxurySingleBtn);
            styleButton(deluxeSingleBtn);
    ...
    // Panel for Availability - Light Green
    ...
    class BookingPanel extends JPanel {
        ...
        public BookingPanel() {
            ...
            styleTextField(name2Field);
            styleTextField(contact2Field);
            styleTextField(gender2Field);
            
            roomTypeCombo.setFont(new Font("Arial", Font.PLAIN, 14));
            
            formPanel.add(createStyledLabel("Room Type:"));
            formPanel.add(roomTypeCombo);
            formPanel.add(createStyledLabel("Room Number:"));
            formPanel.add(roomField);
            formPanel.add(createStyledLabel("Primary Guest Name:"));
            formPanel.add(nameField);
            formPanel.add(createStyledLabel("Primary Guest Contact:"));
            formPanel.add(contactField);
            formPanel.add(createStyledLabel("Primary Guest Gender:"));
            formPanel.add(genderField);
            formPanel.add(createStyledLabel("Secondary Guest Name:"));
            formPanel.add(name2Field);
            formPanel.add(createStyledLabel("Secondary Guest Contact:"));
            formPanel.add(contact2Field);
            formPanel.add(createStyledLabel("Secondary Guest Gender:"));
        ...
        private void styleButton(JButton button) {
            button.setBackground(new Color(219, 112, 147)); // Pale Violet Red
            button.setForeground(Color.WHITE);
            button.setFocusPainted(false);
            button.setFont(new Font("Arial", Font.BOLD, 14));
    ...
    // Panel for Ordering Food - Light Yellow
    class OrderFoodPanel extends JPanel {
        ...
        public OrderFoodPanel() {
            ...
            itemCombo.setFont(new Font("Arial", Font.PLAIN, 14));
            
            formPanel.add(createStyledLabel("Room Number:"));
            formPanel.add(roomField);
            formPanel.add(createStyledLabel("Food Item:"));
        ...
        private void styleButton(JButton button) {
            button.setBackground(new Color(218, 165, 32)); // Golden Rod
            button.setForeground(Color.WHITE);
            button.setFocusPainted(false);
            button.setFont(new Font("Arial", Font.BOLD, 14));
            button.setPreferredSize(new Dimension(150, 35));
    ...
    // Panel for Checkout - Light Coral
    class CheckoutPanel extends JPanel {
        ...
        private void styleButton(JButton button) {
            button.setBackground(new Color(178, 34, 34)); // Fire Brick
            button.setForeground(Color.WHITE);
            button.setFocusPainted(false);
            button.setFont(new Font("Arial", Font.BOLD, 14));
            button.setPreferredSize(new Dimension(150, 35));
